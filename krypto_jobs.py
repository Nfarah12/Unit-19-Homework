...
st.sidebar.write("Ether Balance:", ether_balance, "ETH")
...
if st.sidebar.button("Send Transaction"):
   ...
   # wage_in_wei = w3.to_wei(wage, 'ether')
    transaction_hash = send_transaction(w3, account_info, candidate_address, wage)
